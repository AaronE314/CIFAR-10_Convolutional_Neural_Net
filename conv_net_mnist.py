...
class Conv_Net:
    ...
    def __init__(self, class_names, dataset, saveName, num_predictions=20, epochs=25, batch_size=32, data_aug=False, color=True):
    ...
    def _load_data(self, dataset):
        ...
        self.train_images = self.train_images.reshape(self.train_images.shape[0], self.train_images.shape[1], self.train_images.shape[2], self.color)
        self.test_images = self.test_images.reshape(self.test_images.shape[0], self.test_images.shape[1], self.test_images.shape[2], self.color)
